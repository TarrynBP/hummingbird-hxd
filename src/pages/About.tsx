  ...
  const team = [
    {
      ...
      description:
        "With 8+ years in colour theory and web design, Emme founded HummingBird to bridge the gap between psychology and digital aesthetics.",
    },
    {
      name: "William Hankey",
      role: "Lead Developer",
      description:
        "David specialises in user experience optimisation, using colour psychology to guide user behaviour and improve conversion rates.",
    },
  ];
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-8">
            We're a passionate team of designers, thinkers, and problem-solvers
            who believe that thoughtful design has the power to shift how people
            feel, engage, and move through the world.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                Hummingbird started with a simple frustration: too many digital
                experiences felt clunky, confusing, or just plain forgettable.
                We knew businesses and their customers deserved better.
              </p>
              <p className="text-gray-600 mb-4 leading-relaxed">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Passionate designers and strategists united by our love for colour
