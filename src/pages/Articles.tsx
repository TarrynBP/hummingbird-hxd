...
const Articles = () => {
  ...
  const getCategoryColor = (category: string) => {
    ...
    return (
      colors[category as keyof typeof colors] || "from-mint-teal to-soft-mauve"
    );
  };
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Welcome to our learning space. Read through practical articles on
              improving customer journeys, websites, and the way things run
              behind the scenes. Start at 1 and end with 6. It's a path to
              greater success.
            </p>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center bg-gradient-to-r from-mint-teal/5 to-soft-mauve/5 rounded-2xl p-12">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Let's work together to implement these strategies in your website
            and business processes. Get personalized guidance tailored to your
            specific needs.
          </p>
