  ...
  const values = [
    {
      ...
      description: "We value digital and AI-first thinking to simplify work, enhance experiences, and help small businesses grow confidently."
    },
    {
      icon: Heart,
    ...
    },
    {
      ...
      description: "Your vision combined with our expertise. We team up with clients to bring their unique story to life, thoughtfully."
    },
    {
      icon: Award,
